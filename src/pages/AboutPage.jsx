...
export default function AboutPage() {
  ...
  const storyParagraphs = [
    `Every great journey begins with a simple idea. For LiveFree Hostels, that idea was born in 2017—to create a space where travelers could find more than just a bed for the night. The founders envisioned a place that was vibrant, welcoming, affordable, and community-driven; a place where strangers could become friends and every traveler could feel at home.`,
    `The story began in Rishikesh, a town nestled in the foothills of the Himalayas and blessed by the sacred Ganga River. Known as the Yoga Capital of the World, Rishikesh attracts seekers, adventurers, backpackers, and explorers from every corner of the globe. Recognizing the growing need for quality backpacker accommodation, LiveFree Hostels opened its doors with a mission to combine comfort, culture, adventure, and meaningful human connections.`,
